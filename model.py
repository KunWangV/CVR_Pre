...
def LGB(xtrain, xvalid, ytrain, yvalid, pre_x, use_gpu=True):
...
if __name__ == '__main__':
    ...
    # LR
    if if_CV:
        x, y, groups, pre_x, inst_id = to_LR(df_train, df_pre, with_ohe=True, if_CV=True)
    ...
    # else:
    #     train_x, train_y, test_x, test_y, pre_x, inst_id = to_LGBM(df_train, df_pre, test_days=2, if_CV=False)
    #     ypre, _ = LGB(train_x, test_x, train_y, test_y, pre_x)
