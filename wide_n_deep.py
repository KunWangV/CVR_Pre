...
COLUMNS_DICT = {
    'category': ['creativeID', 'userID', 'positionID', 'adID', 'camgaignID', 'advertiserID', 'appID',
                 'connectionType',
                 'telecomsOperator', 'appPlatform', 'appCategory', ] + \
                ['gender', 'education', 'marriageStatus',
                 'haveBaby', 'hometown_p', 'hometown_c', 'residence_p',
                 'residence_c',
                 'sitesetID', 'positionType', 'clickTime_week'],
    'continue': ['age', 'inst_cnt_appcate', 'inst_cnt_installed', 'inst_cate_percent', 'inst_is_installed',
                 'inst_app_installed', 'action_installed', 'action_cate', 'action_cate_recent', 'tt_is_installed',
                 'tt_cnt_appcate',
                 'clickTime_day', 'clickTime_hour', 'clickTime_minute', ]}
...
def build_estimator(model_dir, model_type):
    ...
    if model_type == "wide":
        ...
        m = tf.contrib.learn.DNNLinearCombinedClassifier(
            ...
            dnn_hidden_units=[1024, 512, 256, 128, 64, 32, 16, 1],
